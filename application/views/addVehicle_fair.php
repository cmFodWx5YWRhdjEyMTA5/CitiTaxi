                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group see1" style="display:none">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">  
                                                <select name="unitPerMinuteforCharge" class="form-control" data-toggle="tooltip" data-placement="top" title="Charge will be calculate accroding to select min"> <!--minMinuteforbasefare-->
                                                    <option value="">Select</option>
                                                    <option value="1">1 min</option>
                                                    <option value="2">2 min</option>
                                                    <option value="5">5 min</option>
                                    ...
                                    <div class="form-group">                                       
                                        <label class="col-md-3 control-label">Peak Hour Surcharge Unit</label>
                                        <div class="col-md-6">              
                                    ...
                                    <div class="form-group">                                       
                                        <label class="col-md-3 control-label">Peak Hour Surcharge Unit</label>
                                        <div class="col-md-6">              
                                            <select name='minNightSurchargeUnit' class="form-control">
                                                <option value="">Select Unit</option>
                                                <option value="Per">Percentage</option>
                                                <option value="Flat">Flat</option>
                                            </select>                                              
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Surcharge Price</label>
                                        <div class="col-md-6 col-xs-12">  
                                            <input type="text" name="minNightSurchargePrice" data-toggle="tooltip" data-placement="top" title="Enter Mid night Surcharge Price link $50, $80 etc" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Surcharge Time Start</label>
                                        <div class="col-md-6 col-xs-12">  
                                            <input type="text" name="minNightSurchargeTimeStart" class="form-control timepicker" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Surcharge Time End</label>
                                        <div class="col-md-6 col-xs-12">  
                                            <input type="text" name="minNightSurchargeTimeEnd" class="form-control timepicker" />
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Standar Cancellatioin Charge (Driver)</label>
                                        <div class="col-md-6 col-xs-12">  
                                    ...
                                    <div class="form-group">                                       
                                        <label class="col-md-3 control-label"><strong>Passenger</strong> Cancellation Charge Unit</label>
                                        <div class="col-md-6">              
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Standar Cancellatioin Charge (Passenger)</label>
                                        <div class="col-md-6 col-xs-12">  
                                    ...
                                    <div class="form-group see6" style="display:none">
                                        <label class="col-md-3 col-xs-12 control-label">Peak hour Cancellatioin Charge (Passenger)</label>
                                        <div class="col-md-6 col-xs-12">  
                                            <input type="text" name="peakHrCancelChargePassenger" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Peak Hour Cancellation per week Limit</label>
                                        <div class="col-md-6 col-xs-12">  
                                            <input type="text" name="peakHourBookingCancelbyPassenger" data-toggle="tooltip" data-placement="top" title="Enter cancel booking limit like:5 , 10, etc. After week cancel limit, passenger account will suspend" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
