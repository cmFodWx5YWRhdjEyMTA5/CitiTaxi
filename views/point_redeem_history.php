<?php $data['page']='coupon'; $data['title']='Point Redeem History'; $this->load->view('layout/header',$data);?>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Point Redeem History</strong></h3>                                    
                                        ...
                                        <tbody>
                                            ...
                                            foreach($history as $list) {  $status = $list->status;?>
                                                <tr>
                                                    ...
                                                    <td ><strong><?php echo $list->status; ?></strong></td>
                                                    <td style="color:red;"><strong><?php echo $list->promo_code;?></strong></td>
                                                    <td><?php echo $list->bonus_amount;?></td>
                                                    <td><?php echo $list->redeem_at;?></td>
                                                ...
                                                <?php 
                                                    ...
                                                    if(!empty($trip)){
                                                        $booking_id = $trip->booking_id_show;  
                                                        $from      = $trip->pickup;
