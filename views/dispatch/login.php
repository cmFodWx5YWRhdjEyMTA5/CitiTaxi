...
<html lang="en" class="body-full-height">
    ...
    <body>
        <div class="login-container">
            ...
            <?php } ?>
                <center><div id="login_heading"><u>DISPATCH PAENL</u></div></center>
                ...
                <div class="login-body">
                    ...
                    <form id="jvalidate" name="frm" class="form-horizontal" method="post" action="<?php echo site_url('Welcome/dispatch_login'); ?>">
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <a href="<?php echo site_url('Welcome/ForgetPassword');?>" class="btn btn-link btn-block">Forgot your password?</a>
                        </div>
                        <div class="col-md-6">
