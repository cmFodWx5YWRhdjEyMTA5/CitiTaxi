<?php $data['page']='driver'; $data['title']='Add driver'; $this->load->view('Sub_admin/layout/header',$data);?>
                ...
                <div class="page-content-wrap">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php }?>
                            <form method="post" action="<?php echo site_url('Sub_admin/addDriver');?>" class="form-horizontal" enctype="multipart/form-data" id="jvalidate" name="frm">
