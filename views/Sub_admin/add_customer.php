<?php $data['page']='two'; $data['title']='Add Customer'; $this->load->view('Sub_admin/layout/header',$data);?>
                ...
                <div class="page-content-wrap">
                    <div class="row">
                        ...
                        <div class="container">  
                            ...
                            <?php }?>
                            <form method="post" action="<?php echo site_url('Sub_admin/add_customer');?>" class="form-horizontal" enctype="multipart/form-data" id="jvalidate" name="frm">
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                               
                                            <input required type="text" name="mobile" id="mobile" class="form-control" maxlength="10"/>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                      
                                            <input type="file" class="fileinput btn-fileinput" name="image" id="filename" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                    <div class="col-md-3">
                                        <a href="<?php echo site_url('Sub_admin/customers'); ?>">
                                        <input type="button" class="btn btn-back" value="Back" style="margin:5px 0; max-width:300px; width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3">
