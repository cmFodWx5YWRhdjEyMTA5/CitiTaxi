<?php $data['page']='driver'; $data['title']='Driver list'; $this->load->view('Sub_admin/layout/header',$data);?>
                                     ...
                                     <table id="example" class="table display">
                                        ...
                                        foreach($userlist as $list) { $status = $list->activeStatus; ?>
                                            <tr>
                                                ...
                                                <?php } else{ ?>
                                                 <td style="text-align:center; color:red;font-weight:600;font-size:13px"><?php echo $list->online_status; ?></td>   
                                                <?php }?>
                                              ...
                                              <!--   <td><a  href="#" id="link1" data-toggle="modal" data-target="#exampleModal">
                                                ...
                                                <td><a target="blank" href="<?php echo site_url('Sub_admin/other_details/'.$list->id);?>"><button class="btn btn-submit">Other Details</button></a>
                                                </td>
                                                <td>
...
<script>
    ...
    function Trip(id)
    {
         var url = '<?php echo site_url('Dispatcher/tripHistroydriver/'); ?>'+id;        
