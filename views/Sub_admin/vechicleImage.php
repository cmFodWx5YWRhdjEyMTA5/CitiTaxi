<?php $data['page']='driver'; $data['title']='Vehicle Image'; $this->load->view('Sub_admin/layout/header',$data);?>
            ...
            <!-- PAGE CONTENT WRAPPER -->
                ...
                <div class="page-content-wrap">
                 ...
                 <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url('Dispatcher/other_details/'.$driverid);?>">Other Details</a></li>

                        <li class="active">Vehicle Images</li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                      ...
                                      <h3 class="panel-title"><strong>Vehicle </strong> Image</h3> 
                                        ...
                                        foreach($images as $img) { ?>
                                            ...
                                            <tr>
                                             ...
                                             <!--    <td>                                                    
                                                 ...
                                                 <div style="margin-top:15%"><input type="file" id="file<?php echo $img->image_id;?>" value="Select"></div>

                                                 <div style="margin-top:2%">

                                                    <input type="button" onclick="imageUpdate<?php echo $img->image_id;?>(<?php echo $img->image_id; ?>)" class="btn btn-submit" value="Update">
                                                ...
                                                <td>
                                                  ...
                                                  <input type="button" value="Delete" class="btn btn-reset" onclick="deleteimage(<?php echo $img->image_id;?>)" style="margin-top:26%">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">     
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="upload" class="btn btn-submit">Upload</button>
