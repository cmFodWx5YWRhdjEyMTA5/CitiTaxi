<?php $data['page']='driver'; $data['title']='Driver other details'; $this->load->view('Sub_admin/layout/header',$data);?>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Vehicle Details</strong></h3>        
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                     ...
                                     <table id="customers2" class="table">
                                        <thead>
                                            <tr>
                                            <th style="min-width:80px;">Vehicle id</th>
                                            <th>Driver id</th>
                                            <th>Brand</th>
                                            <th>Sub Brand</th>
                                            <th>Number Plate</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url('Sub_admin/vechileImage/'.$vechile_details->driver_id.'/'.$vechile_details->vechileId);?>"><button class="btn btn-submit">Vehicle Image</button></a>
                                                    <!--input type="button" class="btn btn-submit" value="Vechile Image"-->
                                                </td>
                                                <!-- <td>
                                                    <a href="<?php echo site_url('Sub_admin/updateVechile/'.$vechile_details->vechileId);?>">
