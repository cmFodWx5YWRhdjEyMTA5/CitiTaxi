            ...
            <?php } ?>
               ...
               <div class="login-logo" style="margin-left:25% !important;"><img src="<?php echo base_url('assest/cititaxiIcon.png'); ?>" style="border-radius:15%; width:200px; height:80px"></div>
                ...
                <div class="login-body">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo site_url("Dispatcher/ForgetPassword");?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="<?php echo site_url();?>/Dispatcher" class="btn btn-link btn-block" style="font-size:16px; margin-top:20px;">Back to LogIn</a>
