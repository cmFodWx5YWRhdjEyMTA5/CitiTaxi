...
<html lang="en" class="body-full-height">
    ...
    <style>
        ...
        <!-- META SECTION -->
        <title>Recover wallet pin</title>            
        ...
        <div class="login-container">
            ...
            <div class="login-logo" style="margin-left:25% !important;"><img src="<?php echo base_url('assest/cititaxiIcon.png'); ?>" style="border-radius:15%; width:200px; height:80px"></div>
                ...
                <div class="login-body">
                    <div class="login-title"><strong>Reset wallet Pin</strong></div>
                    <form class="form-horizontal" id="jvalidate" method="post" action="<?php echo site_url('Welcome/reset_password?email='.$email); ?>">
