...
<?php $data['page']='driver'; $data['title']='Complete registration'; $this->load->view('layout/header',$data);?>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                   <h3 class="panel-title"><strong>Complete registration</strong></h3>                           
                                </div>
                            <div class="container">                                      
                            ...
                            <form method="post" action="<?php echo site_url('Driver/complete_registration/'.$userdata->id);?>" class="form-horizontal" enctype="multipart/form-data" id="jvalidate" name="frm">
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <?php 
                                            $vehicle=getSingleDetail('driver_license',array('user_id'=>$userdata->id));
                                            if(!empty($vehicle))
                                            { ?>
                                                <img src="<?php echo base_url('licenseImage/'.$vehicle->licenseImage); ?>" width="120px" height="80px">
                                            <?php  } else { ?>
