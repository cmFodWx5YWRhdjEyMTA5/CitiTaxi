<?php $data['page']='revenue'; $data['title']='Weekly Earning'; $this->load->view('layout/header',$data);?> 
 <style type="text/css">
                ...
                <div class="page-content-wrap">
                  <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Weekly Earning</strong></h3>
                      ...
                      <div class="panel-body">
                        <form action="<?php echo site_url('Vehicle/weekly_earning'); ?>" method="POST">
