<?php $data['page']='revenue'; $data['title']='Monthly Earning'; $this->load->view('layout/header',$data);?> 
 <style type="text/css">
                ...
                <div class="page-content-wrap">
                  <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Monthly Earning</strong></h3>
                      ...
                      <div class="panel-body">
                        <form action="<?php echo site_url('Vehicle/monthly_earning'); ?>" method="POST">
                          ...
                          <div class="col-md-3 col-xs-3" style="margin-top:.5%;">
                                  <input type="text" name="date" id="date" data-provide="datepicker" class="form-control" placeholder="Select Start Date" required>
                          </div>
