...
<?php $data['page']='six'; $data['title']='Update refferal_setting'; $this->load->view('layout/header',$data);?>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                   <h3 class="panel-title"><strong>Update Refferal setting</strong></h3>                           
                                </div>
                            <div class="container">                                      
                            ...
                            <form method="post" action="<?php echo site_url('Home/update_referral/'.$setting->referral_setting_id);?>" class="form-horizontal" enctype="multipart/form-data" id="jvalidate" name="frm">
                                <div class="panel-body form-group-separated">                                
                                    ...
                                    <div class="form-group">                                       
                                        ...
                                        <div class="col-md-6">              
                                            <select name='country_id' class="form-control select" data-live-search="true" onChange="get_currency(this)" required>
                                                <option value="<?php echo $setting->country_id; ?>"><?php echo $setting->country; ?></option>
                                            ...
                                            <input type="hidden" name="country" id="country_name" value="<?php echo $setting->country; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Currency</label>
                                        <div class="col-md-6 col-xs-12">
                                            <input type="text" name="currency" id="currency" class="form-control" value="<?php echo $setting->currency; ?>" readonly> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                      
                                            <select class="form-control select" data-live-search="true" name="time_zone">
                                                <option value="<?php echo $setting->time_zone;?>"><?php echo $setting->time_zone; ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                               
                                            <input type="text" name="amount_to_frnd" class="form-control" value="<?php echo $setting->amount_to_frnd; ?>" />
                                        </div>                                        
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" name="bonus_to_referral" class="form-control" value="<?php echo $setting->bonus_to_referral; ?>">                                            
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Get Bonus after (x) ride</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" name="min_ride" class="form-control" value="<?php echo $setting->min_ride; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" name="within_days" class="form-control" value="<?php echo $setting->within_days; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                               
                                            <textarea class="form-control" rows="3" name="description"><?php echo $setting->description; ?></textarea>
                                        </div>                                        
                                    </div>
